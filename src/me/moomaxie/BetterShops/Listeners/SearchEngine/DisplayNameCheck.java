...
public class DisplayNameCheck {
    ...
    public static void searchByName(Inventory inv,Player p, Shop shop, String search, boolean sell) {
    ...
    private static void openShopWithSearch(Inventory inv, Player p, Shop shop, int page, boolean sell, List<String> items) {
        ...
        for (ItemStack it : shop.getShopContents(sell).keySet()) {
            ...
            if (it.getItemMeta().getDisplayName() != null) {
                ...
                for (String s : items) {
                    if (it.getItemMeta().getDisplayName().contains(s)) {
                        yes = true;
                    }
                }
                ...
                if (yes) {
                    ...
                    if (items.contains(it.getItemMeta().getDisplayName())) {
