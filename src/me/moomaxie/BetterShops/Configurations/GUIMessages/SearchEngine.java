...
public class SearchEngine {
    ...
    public static File file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/SearchEngine.yml");
    ...
    public static void changeSearchEngineConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("SearchEngine.yml")) {
                            found3 = true;
                        }
                    }
                }
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/SearchEngine.yml")) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the Search Engine Language file.");
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/SearchEngine.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the Search Engine Language file.");
