...
public class ShopSettings {
    ...
    public static void changeShopSettingsConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("ShopSettings.yml")) {
                            found3 = true;
                        }
                    }
                }
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/ShopSettings.yml")) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the Shop Settings Language file.");
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/ShopSettings.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the Shop Settings Language file.");
        ...
        file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/ShopSettings.yml");
