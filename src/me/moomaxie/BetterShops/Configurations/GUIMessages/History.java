...
public class History {
    ...
    public static void changeHistoryConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("History.yml")) {
                            found3 = true;
                        }
                    }
                }
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/History.yml")) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the History Language file.");
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/History.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the History Language file.");
