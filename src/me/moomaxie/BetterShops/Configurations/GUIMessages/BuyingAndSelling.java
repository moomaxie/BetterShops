...
public class BuyingAndSelling {
    ...
    public static String getString(String name){
        if (config.isString(name)){
            return config.getString(name).replaceAll("&","§").replaceAll(Pattern.quote("\n")," \n ");
        } else {
            return "";
        }
    }
    ...
    public static void changeBuyingAndSellingConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("BuyingAndSelling.yml")) {
                            found3 = true;
                        }
                    }
                }
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/BuyingAndSelling.yml")) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the Buying And Selling Language file.");
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/BuyingAndSelling.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the Buying And Selling Language file.");
