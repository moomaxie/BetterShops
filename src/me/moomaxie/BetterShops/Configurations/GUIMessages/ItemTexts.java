...
public class ItemTexts {
    ...
    private static File file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/ItemTexts.yml");
    ...
    public static void changeItemTextsConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("ItemTexts.yml")) {
                            found3 = true;
                        }
                    }
                }
        ...
        if (!found3) {
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/ItemTexts.yml")) {
                    File f = new File(Core.getCore().getDataFolder() + File.separator + file.getName());
                    try {
                        ItemTexts.file.createNewFile();
                    } catch (IOException e) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the Item Text Language file.");
            ...
            if (config != null) {
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/ItemTexts.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the Item Text Language file.");
                ...
                file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/ItemTexts.yml");
