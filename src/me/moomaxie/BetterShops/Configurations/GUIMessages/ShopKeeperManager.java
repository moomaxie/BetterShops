...
public class ShopKeeperManager {
    ...
    private static File file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/ShopKeeperManager.yml");
    ...
    public static void changeShopKeeperManagerConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("ShopKeeperManager.yml")) {
                            found3 = true;
                        }
                    }
                }
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/ShopKeeperManager.yml")) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the Shop Keeper Manager Language file.");
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/ShopKeeperManager.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the Shop Keeper Manager Language file.");
