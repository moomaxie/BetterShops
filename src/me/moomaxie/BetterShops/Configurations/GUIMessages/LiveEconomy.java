 ...
 * ************************************************************************
 */
public class LiveEconomy {

    public static File file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/LiveEconomy.yml");
    ...
    public static void changeLiveEconomyConfig() {
            ...
            for (File f : Core.getCore().getDataFolder().listFiles()) {
                if (f.getName().equals("Language")) {
                    for (File file1 : f.listFiles()) {
                        if (file1.getName().equals("LiveEconomy.yml")) {
                            found3 = true;
                        }
                    }
                }
        ...
        if (!found3) {
            ...
            while (enumEntries.hasMoreElements()) {
                ...
                if (file.getName().equals("Language/LiveEconomy.yml")) {
                    ...
                    try {
                        ...
                        fos.close();
                        is.close();
                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eCreated the Live Economy Language file.");
            ...
            if (config != null) {
                            ...
                            while (enumEntries.hasMoreElements()) {
                                ...
                                if (file.getName().equals("Language/LiveEconomy.yml")) {
                                    ...
                                    try {
                                        ...
                                        fos.close();
                                        is.close();
                                        Bukkit.getConsoleSender().sendMessage("§bBetterShops§7 - §eChanged the Live Economy Language file.");
                ...
                file = new File(Bukkit.getPluginManager().getPlugin("BetterShops").getDataFolder(), "Language/LiveEconomy.yml");
