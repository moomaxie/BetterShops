...
public class ShopsNPC {
    ...
    public ShopsNPC(final EntityType e, final List<String> lore, final Shop s, final Boolean... b) {
        shop = s;
        l = shop.getLocation();
        boolean ca = false;
        try {
            ...
            if (e == EntityType.SHEEP) {
                entity.getClass().getMethod("setSheared", boolean.class).invoke(entity, b[1]);
            }
            if (e == EntityType.ZOMBIE) {
                entity.getClass().getMethod("setVillager", boolean.class).invoke(entity, b[2]);
            }
    ...
    public void spawn() {
        if (!entity.isValid() && entity.isDead()) {
            ...
            try {
                entity = Spawner.spawnEntity(entity.getType(), shop.getLocation());
            } catch (Exception e) {
