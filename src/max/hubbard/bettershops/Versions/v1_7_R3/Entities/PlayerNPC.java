package max.hubbard.bettershops.Versions.v1_7_R3.Entities;

import net.minecraft.util.com.mojang.authlib.GameProfile;
import max.hubbard.bettershops.Versions.v1_7_R3.NPCConnection;
...
public class PlayerNPC extends EntityPlayer {
    ...
    public PlayerNPC(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager) {
        ...
        sendPacketsTo(Bukkit.getOnlinePlayers(), new PacketPlayOutPlayerInfo("AddPlayer",true,0));
    }
